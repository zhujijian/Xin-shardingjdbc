...
public class IntervalUtil {
    ...
    public static void main(String[] args) {
        System.out.println(IntervalUtil.isInTheInterval("5.5", "[0,6)"));
        System.out.println(IntervalUtil.isInTheInterval("7.1", "(-∞,6]"));
        System.out.println(IntervalUtil.isInTheInterval("32.5", "[32,∞"));
    }
